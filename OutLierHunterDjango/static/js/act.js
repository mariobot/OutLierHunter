...
// MÃ¡s adelante serÃ­a interesante un wrapper de console Â¿?
if (REAL.debug){
	if (!window.console){
...
// listado de eventos de la pÃ¡gina
...
REAL.WonderItem = function (config) {
	...
	this.addListeners = function () {
		...
		// aÃ±adimos el evento de click del elemento
	...
	this.onClick = function (e) {
		...
		// se transforma hasta la posiciÃ³n definitiva
...
//		window.requestAnimFrame(_that.onInterval, null);
	...
	this.addListeners = function () {
		...
		// aÃ±adimos el evento de mouse-move en todo el documento
	...
	this.onInterval = function () {
		...
		if (_mouseY !== null && _wonderGriding){
			...
			// calculamos la repulsiÃ³n de los puntos
			var i;
